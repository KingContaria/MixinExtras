...
public class WrapMethodApplicatorExtension implements IExtension {
    ...
    static void offerWrapper(Target target, MethodNode handler, Type operationType, List<ShareInfo> shares, boolean captureTargetArgs) {
        ...
        relevant.put(target.method, new WrapMethodStage.Wrapper(inner, handler, operationType, shares, captureTargetArgs));
    }
